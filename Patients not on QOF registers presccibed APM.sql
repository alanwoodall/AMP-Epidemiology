--patients prescribed an antipsychotic
...
FROM
 ...
 ROW_NUMBER () OVER (PARTITION BY ALF_PE ,
		EVENT_DT
	ORDER BY
		EVENT_DT ) AS PRESCRIPTION_NUMBER
	FROM
...
FROM
	...
	LEFT JOIN SAILW1384V.DISEASEREGISTERREADCODES_AG2 da ON --amend 24022024 from AG to AG2
